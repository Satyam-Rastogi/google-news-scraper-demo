...
async def generate_markdown_async(article_data: Dict[str, Any], output_dir: str) -> Optional[str]:
    """
    Generate a Markdown file for a full article asynchronously.
    ...
    try:
        ...
        # Save content to file asynchronously using aiofiles
        try:
            import aiofiles
            ...
            logging.error(f"Error writing Markdown file for article '{title}': {e}")
            return None
