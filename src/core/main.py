...
def main_cli(queries: Optional[List[str]] = None, output_format: Optional[str] = None, 
    ...
    for query in validated_queries:
        ...
        articles: List[ArticleDict] = collect_news(query, output_format, limit=limit, image_mode=image_mode)
